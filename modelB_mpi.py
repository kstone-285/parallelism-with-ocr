...
# ----------------------------------------------------------------------------
# 스테이지별 워커 함수 (ipyparallel 엔진에서 실행됨)
...
def stage3_save_worker(item):
    """S3: 최종 결과를 받아 저장 형식으로 만듭니다. (여기서는 단순 반환)"""
    import os
    pid = os.getpid()
...
def main():
    ...
    # 남아있는 S2, S3 작업들이 모두 완료될 때까지 기다림
